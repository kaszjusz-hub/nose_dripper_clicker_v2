...
// ÔöÇÔöÇÔöÇ Upgrades ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ



class NoseUpgrade {

  final int level; // 1ÔÇô6 (first 3 always available, 4ÔÇô6 need DNA)
...
// ÔöÇÔöÇÔöÇ GameState ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
class GameState {
  ...
  void _checkAutoBacteriaSpawn() {
    ...
    // Allergy pollen spawn
    if (bacteriaUnlocked && !pollenVisible) {
      _maybeSpawnAllergy();
    }
  ...
  static const Map<String, Map<String, dynamic>> _virusData = {
    ...
    'speed':   {'name': 'Wirus Szybko┼Ťci',  'icon': 'ÔÜí', 'bonus': 0.05},

    'luck':    {'name': 'Wirus Szcz─Ö┼Ťcia',   'icon': '­čŹÇ', 'bonus': 0.10},

    'yield':   {'name': 'Wirus Wydajno┼Ťci', 'icon': '­čĺÄ', 'bonus': 0.05},

    'combo':   {'name': 'Wirus Combo',      'icon': '­čöą', 'bonus': 0.03},

    'passive': {'name': 'Wirus Pasywny',     'icon': '­čîŐ', 'bonus': 0.08},
  ...
  String _virusIcon(String effect) => _virusData[effect]?['icon'] ?? 'Ôśú´ŞĆ';

  double _virusBonus(String effect) => _virusData[effect]?['bonus'] ?? 0.0;



  // ÔöÇÔöÇ Core resources ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  // ÔöÇÔöÇ Upgrades (reset on Rebirth) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  // ÔöÇÔöÇ DNA Upgrades (persistent across Rebirth) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ

  Map<String, int> dnaUpgradeLevels = {};



  // ÔöÇÔöÇ Systems ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  // ÔöÇÔöÇ Thresholds ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ

  static const double baseRebirthThreshold = 10000000.0; // 10M ml ÔÇö always constant
  ...
  // ÔöÇÔöÇ Internal ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  double _pollenLeft = 0.0;
  double _pollenTop = 0.0;
  double _pollenSize = 40.0;
  DateTime? _allergyEndsAt;

  bool get allergyActive => _allergyActive;
  double get pollenLeft => _pollenLeft;
  double get pollenTop => _pollenTop;
  double get pollenSize => _pollenSize;
  bool get pollenVisible => _allergyActive && _pollenLeft > 0;
  ...
  /// Allergy multiplier (2.0 when active)
  double get allergyMultiplier => _allergyActive ? 2.0 : 1.0;
  ...
  // ÔöÇÔöÇ Constants ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  // ÔöÇÔöÇ Nose upgrade definitions ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ

  // Game Design: First upgrade costs ~15 glut├│w (10% of base clickYield)

  // so players can buy it after ~1 click, giving instant feedback.

  // Scaling at 1.8^i keeps each level affordable while preserving

  // exponential progression ÔÇö Lv6 is ~283 glut├│w (reachable quickly).

  // perClickBonus reduced from 50*i to 10*i to match ÔÇö max +60/click
  ...
  static final List<NoseUpgrade> noseUpgrades = [
    ...
    NoseUpgrade(level: 1, name: 'Nose Lv.1', icon: '­čĹâ', baseCost: 5, perClickBonus: 0.1),

    NoseUpgrade(level: 2, name: 'Nose Lv.2', icon: '­čĹâ', baseCost: 50, perClickBonus: 1.0),

    NoseUpgrade(level: 3, name: 'Nose Lv.3', icon: '­čĹâ', baseCost: 500, perClickBonus: 10.0),

    NoseUpgrade(level: 4, name: 'Nose Lv.4', icon: '­čžČ­čĹâ', baseCost: 5000, perClickBonus: 100.0),

    NoseUpgrade(level: 5, name: 'Nose Lv.5', icon: '­čžČ­čĹâ', baseCost: 50000, perClickBonus: 1000.0),

    NoseUpgrade(level: 6, name: 'Nose Lv.6', icon: '­čžČ­čĹâ', baseCost: 500000, perClickBonus: 10000.0),

  ];



  // ÔöÇÔöÇ Room upgrade definitions ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ

  static final List<RoomUpgrade> roomUpgrades = [

    RoomUpgrade(level: 1, name: 'Fan', icon: '­čîÇ', baseCost: 5, dripPerSec: 0.2),

    RoomUpgrade(level: 2, name: 'Humidifier', icon: '­čĺĘ', baseCost: 16, dripPerSec: 0.6),

    RoomUpgrade(level: 3, name: 'Couch', icon: '­čŤő´ŞĆ', baseCost: 51, dripPerSec: 1.5),

    RoomUpgrade(level: 4, name: 'TV Stand', icon: '­čô║', baseCost: 164, dripPerSec: 4.0),

    RoomUpgrade(level: 5, name: 'Bookshelf', icon: '­čôÜ', baseCost: 525, dripPerSec: 10.0),

    RoomUpgrade(level: 6, name: 'Wardrobe', icon: '­č¬×', baseCost: 1680, dripPerSec: 30.0),

  ];



  // ÔöÇÔöÇ DNA upgrade definitions ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  static final List<DnaUpgradeDef> dnaUpgrades = [
    ...
    DnaUpgradeDef(
      ...
      description: 'Odblokowuje silniejsze meble (poziomy 4ÔÇô6).',
    ...
    DnaUpgradeDef(
      ...
      description: 'Odblokowuje szans─Ö na mutacj─Ö bakterii w wirusa (bazowo 2%).',
    ...
    DnaUpgradeDef(
      ...
      description: 'Zwi─Öksza szans─Ö mutacji bakterii w wirusa o +3% per level.',
  ...
  /// Glut yield per click (base ├Ś nose levels ├Ś threshold multipliers)
  ...
  /// Passive glut drip per second (room upgrades ├Ś threshold multipliers)
  ...
  // ÔöÇÔöÇÔöÇ Threshold / Milestone System ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  /// Combo multiplier: 1.00 Ôćĺ 2.00 (each 5 combo = +0.05x, cap at 100)
  ...
  /// DNA to earn if rebirth now ÔÇö scales with tank fill (10 DNA per full threshold)
  ...
  void clickNose() {
    ...
    final gained = clickYield * totalMultiplier * allergyMultiplier;
  ...
  void clickBacteria() {
    ...
    // Reward: passive drip per second ├Ś 300
  ...
  /// Perform rebirth ÔÇö resets tank to 0, keeps DNA upgrades
  ...
  void doRebirth() {
    ...
    // Rebirth threshold stays constant ÔÇö no increase!
  ...
  void gameTick(double dt) {
    ...
    if (passiveDrip > 0) {
      ...
      final gained = passiveDrip * dt * totalMultiplier * allergyMultiplier;
  ...
  NoseUpgrade _getNoseDef(int level) {
    ...
    if (level < 1 || level > 6) throw RangeError('Nose level must be 1ÔÇô6');
  ...
  // ── Allergy system helpers ───────────────────────────────────────

  void _maybeSpawnAllergy() {
    if (_random.nextDouble() < 0.15) {
      _allergyActive = true;
      _allergyEndsAt = DateTime.now().add(const Duration(seconds: 30));
      _pollenLeft = 50.0 + _random.nextDouble() * 200.0;
      _pollenTop = 100.0 + _random.nextDouble() * 300.0;
    }
  }

  void _deactivateAllergy() {
    if (!_allergyActive) return;
  ...
  void updateAllergy() {
    if (!_allergyActive || _allergyEndsAt == null) return;
  ...
  void clickPollen() {
    if (!pollenVisible) return;
    _deactivateAllergy();
  }

  void startAllergySystem() {
    _allergyTimer?.cancel();
    _allergyTimer = Timer.periodic(const Duration(seconds: 2), (_) {
      if (!bacteriaUnlocked) return;
      if (pollenVisible) return;
      _maybeSpawnAllergy();
    });
